...
public class Page146Ex1 {
	...
	public static void main(String[] args) {
		...
		// String mas[] = { "kfdklf", "asdkjjk ffdsfadsf", "aaaaa", "bla", "bla" }; //
		// для отладки
		...
		System.out.println("\n----Введенный массив:");
		Page146Ex1.showMas(mas); // ?? правильно ли так и почему нужно указывать имя класса ? мы же ведь в немже
									// находимся
		...
		tempstr = mas[mas.length - 1];
		String[] newmas = tempstr.split(" "); // разделяет строку на подстроки
		System.out.println("----разделить самую длинную строку на слова");
		Page146Ex1.showMas(newmas);

		// Определить является ли второй символ самой короткой строки цифрой

		// здесь будет ошибка выскакивать так как самая короткая строка у нас из одного
		// символа
