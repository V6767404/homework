...
//случайных целых чисел из отрезка [-5;5]. ¬ывести массив на экран.
//ќпределить и вывести на экран индекс строки с наибольшим по модулю
//произведением элементов. ≈сли таких строк несколько, то вывести индекс
//первой встретившейс€ из них.
